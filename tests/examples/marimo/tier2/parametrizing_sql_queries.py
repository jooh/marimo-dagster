"""Parametrize SQL queries with Python values example.

Demonstrates how to use Python f-string interpolation to dynamically
parameterize SQL queries with UI element values.

Source: https://github.com/marimo-team/marimo
        examples/sql/parametrizing_sql_queries.py
License: Apache-2.0
"""
