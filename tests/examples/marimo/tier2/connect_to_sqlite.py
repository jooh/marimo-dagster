...
Demonstrates how to attach and query a SQLite database using marimo's SQL
cells with DuckDB's SQLite extension.

Source: https://github.com/marimo-team/marimo
        examples/sql/connect_to_sqlite.py
License: Apache-2.0
"""
...
def _():
    ...
    return (mo, download_sample_data)
