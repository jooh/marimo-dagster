"""Polars DataFrame operations example.

Demonstrates using Polars for data manipulation with interactive filtering
and visualization capabilities.

Source: https://github.com/marimo-team/marimo
        examples/third_party/polars/polars_example.py
License: Apache-2.0
"""
