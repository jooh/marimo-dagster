"""Read CSV data via SQL example.

Demonstrates how to read a CSV file from a local file or URL into an in-memory
table using marimo's SQL integration with DuckDB.
